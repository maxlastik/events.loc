                ...
                <div class="col-12 col-sm-3 text-end">
                    @if(Auth::user())
                        @switch(Auth::user()->role)
                            @case(1)
                                <a href="{{ route('dashboard-admin') }}" type="button" class="btn btn-light me-2 rounded-pill px-4">Admin Panel</a>
                                @break
                            @case(2)
                                <a href="{{ route('member.profile.show') }}" type="button" class="btn btn-light me-2 rounded-pill px-4">My Profile</a>
                                @break
                        @endswitch
                    @else
                        <a href="{{ route('login') }}" type="button" class="btn btn-light me-2 rounded-pill px-4">Login</a>
                        <a href="{{ route('register') }}" type="button" class="btn btn-primary rounded-pill px-4">Sign-up</a>
                    @endif
                </div>
            </header>
