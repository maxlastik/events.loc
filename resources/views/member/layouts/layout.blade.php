        ...
        <div class="container-fluid container-xxl flex-shrink-0">
            <header class="d-flex flex-wrap align-items-center justify-content-center justify-content-md-between py-3 mb-4 border-bottom">
                ...
                <div class="col-12 col-sm-3 text-end">
                    <a href="{{ route('logout') }}" type="button" class="btn btn-light me-2 rounded-pill px-4" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">Sign Out</a>
            ...
            <main>
                <div class="mb-4">
                    <a type="button" class="btn btn-light {{ request()->is('dashboard-user/profile*') ? 'active' : '' }}" href="{{ route('member.profile.show') }}">My Profile</a>
